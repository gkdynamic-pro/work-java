class Student 
{
 ...
 {
     this.age =age; // "this" keyword is use use to differtiate instance variables from local varibles when they have same name 
                    // "this" keyword  current object ke instances variable ko refer karta hai, especially jab local aur instance variables ka naam same ho
...
public class ShadowingProblemSolve {
